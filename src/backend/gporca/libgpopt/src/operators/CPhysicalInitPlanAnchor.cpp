...
//---------------------------------------------------------------------------
//	@function:
//		CPhysicalInitPlanAnchor::CPhysicalInitPlanAnchor
//
//	@doc:
//		Ctor
//
//---------------------------------------------------------------------------
CPhysicalInitPlanAnchor::CPhysicalInitPlanAnchor(CMemoryPool *mp)
...
//---------------------------------------------------------------------------
//	@function:
//		CPhysicalInitPlanAnchor::Matches
//
//	@doc:
//		Match operators
//
//---------------------------------------------------------------------------
BOOL
CPhysicalInitPlanAnchor::Matches(COperator *pop) const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CPhysicalInitPlanAnchor::PcrsRequired
//
//	@doc:
...
//---------------------------------------------------------------------------
CColRefSet *
CPhysicalInitPlanAnchor::PcrsRequired(CMemoryPool *mp,
...
//---------------------------------------------------------------------------
//	@function:
//		CPhysicalInitPlanAnchor::PcteRequired
//
//	@doc:
...
//---------------------------------------------------------------------------
CCTEReq *
CPhysicalInitPlanAnchor::PcteRequired(CMemoryPool *mp,
									  CExpressionHandle &exprhdl,
...
//---------------------------------------------------------------------------
//	@function:
//		CPhysicalInitPlanAnchor::FProvidesReqdCols
//
//	@doc:
...
//---------------------------------------------------------------------------
BOOL
CPhysicalInitPlanAnchor::FProvidesReqdCols(CExpressionHandle &exprhdl,
										   CColRefSet *pcrsRequired,
										   ULONG  // ulOptReq
) const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CPhysicalInitPlanAnchor::PdsRequired
//
//	@doc:
...
//---------------------------------------------------------------------------
CDistributionSpec *
CPhysicalInitPlanAnchor::PdsRequired(CMemoryPool *mp,
									 CExpressionHandle &
#ifdef GPOS_DEBUG
										 exprhdl
#endif	// GPOS_DEBUG
									 ...
									 ULONG ulOptReq) const
{
	...
	GPOS_ASSERT(CDistributionSpec::EdtSingleton == pdsRequired->Edt());
...
//---------------------------------------------------------------------------
//	@function:
//		CPhysicalInitPlanAnchor::PosRequired
//
//	@doc:
...
//---------------------------------------------------------------------------
COrderSpec *
CPhysicalInitPlanAnchor::PosRequired(CMemoryPool *mp,
									 CExpressionHandle &,  // exprhdl,
...
//---------------------------------------------------------------------------
//	@function:
//		CPhysicalInitPlanAnchor::PrsRequired
//
//	@doc:
...
//---------------------------------------------------------------------------
CRewindabilitySpec *
CPhysicalInitPlanAnchor::PrsRequired(CMemoryPool *,		   // mp,
									 CExpressionHandle &,  // exprhdl,
...
//---------------------------------------------------------------------------
//	@function:
//		CPhysicalInitPlanAnchor::PosDerive
//
//	@doc:
//		Derive sort order
//
//---------------------------------------------------------------------------
COrderSpec *
CPhysicalInitPlanAnchor::PosDerive(CMemoryPool *,  // mp,
...
//---------------------------------------------------------------------------
//	@function:
//		CPhysicalInitPlanAnchor::PdsDerive
//
//	@doc:
//		Derive distribution
//
//---------------------------------------------------------------------------
CDistributionSpec *
CPhysicalInitPlanAnchor::PdsDerive(CMemoryPool *,  // mp,
								   CExpressionHandle &exprhdl) const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CPhysicalInitPlanAnchor::PrsDerive
//
//	@doc:
...
//---------------------------------------------------------------------------
CRewindabilitySpec *
CPhysicalInitPlanAnchor::PrsDerive(CMemoryPool *,  //mp
								   CExpressionHandle &exprhdl) const
{
	const ULONG arity = exprhdl.Arity();
	GPOS_ASSERT(1 <= arity);
	...
	// TODO: shardikar; Fix this implementation. Although CPhysicalInitPlanAnchor is
...
//---------------------------------------------------------------------------
//	@function:
//		CPhysicalInitPlanAnchor::EpetOrder
//
//	@doc:
...
CPhysicalInitPlanAnchor::EpetOrder(CExpressionHandle &exprhdl,
...
//---------------------------------------------------------------------------
//	@function:
//		CPhysicalInitPlanAnchor::EpetRewindability
//
//	@doc:
...
//---------------------------------------------------------------------------
CEnfdProp::EPropEnforcingType
CPhysicalInitPlanAnchor::EpetRewindability(CExpressionHandle &,	 // exprhdl
