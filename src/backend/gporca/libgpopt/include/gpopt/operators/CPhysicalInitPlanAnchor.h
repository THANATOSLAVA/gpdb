...
//
//	@filename:
//		CPhysicalInitPlanAnchor.h
//
//	@doc:
//---------------------------------------------------------------------------
#ifndef GPOPT_CPhysicalInitPlanAnchor_H
#define GPOPT_CPhysicalInitPlanAnchor_H
...
//---------------------------------------------------------------------------
//	@class:
//		CPhysicalInitPlanAnchor
//
//	@doc:
//		Physical sequence operator
//
//---------------------------------------------------------------------------
class CPhysicalInitPlanAnchor : public CPhysical
{
private:
...
public:
	CPhysicalInitPlanAnchor(const CPhysicalInitPlanAnchor &) = delete;

	// ctor
	explicit CPhysicalInitPlanAnchor(CMemoryPool *mp);

	// dtor
	~CPhysicalInitPlanAnchor() override;

	// ident accessors
	EOperatorId
	Eopid() const override
	{
		return EopPhysicalInitPlanAnchor;
	}
	...
	SzId() const override
	{
		return "CPhysicalInitPlanAnchor";
	}
...
};	// class CPhysicalInitPlanAnchor

}  // namespace gpopt

#endif	// !GPOPT_CPhysicalInitPlanAnchor_H
